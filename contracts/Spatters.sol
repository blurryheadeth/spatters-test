 ...
 * 999 total supply with exponential pricing and dual-tier anti-whale protection:
 * - Global cooldown: 1 hour between ANY mints by ANY wallet
 * - Per-wallet cooldown: 24 hours between mints by the SAME wallet
...
contract Spatters is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant GLOBAL_COOLDOWN = 1 hours;      // Between any mints
    uint256 public constant WALLET_COOLDOWN = 24 hours;     // Per wallet
    ...
    /**
     * @dev Public mint for tokens 26-999 with dual-tier anti-whale protection
     * Enforces both global cooldown (1 hour between any mints) and 
     * per-wallet cooldown (24 hours between same wallet's mints)
    ...
    function mint(string memory metadata) external payable nonReentrant {
        ...
        // Global cooldown: Anyone must wait 1 hour after last mint
        // Skip check for first public mint (token #26)
        ...
        // Per-wallet cooldown: This wallet must wait 24 hours since their last mint
        require(
